...
// Removed 'CardTitle' from the import as it's unused
...
export default function Home() {
  ...
  // Replaced 'any' with a more specific type
  const [storyPlans, setStoryPlans] = useState<string[]>([]);
  ...
  // Replaced 'any' with a more specific type for storyHistory
