...
const API_URL = process.env.NEXT_PUBLIC_GPT_API_URL || 'https://api.openai.com/v1/chat/completions';
const API_KEY = process.env.NEXT_PUBLIC_GPT_API_KEY || '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';
