  ...
  return (
    <div className="flex flex-col items-center p-6 max-w-3xl mx-auto">
      ...
      <p className="text-gray-500 mb-6 text-center">
        Create engaging lesson hooks to capture your students' attention
        effectively.
      </p>
      ...
      <div className="w-full bg-white p-6 shadow-md rounded-lg">
        <div className="grid grid-cols-2 gap-4 mb-4">
          ...
          <div>
            ...
            <select
              className={`w-full p-2 border rounded mb-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-600 focus-visible:ring-offset-2 ${
        ...
        <div className="mb-4">
          ...
          <select
            ...
            className={`w-full border p-2 rounded mb-4 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-600 focus-visible:ring-offset-2 ${
              isGenerated ? "opacity-50 cursor-not-allowed" : ""
            }`}
            disabled={isGenerated}
          >
        ...
        <select
          ...
          className={`w-full p-2 border rounded mb-4 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-600 focus-visible:ring-offset-2 ${
            isGenerated ? "opacity-50 cursor-not-allowed" : ""
          }`}
          disabled={isGenerated}
        >
        ...
        <Button
          ...
          className={`w-full bg-rose-600 text-white py-2 rounded hover:bg-rose-700 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-600 focus-visible:ring-offset-2 ${
            !allFieldsFilled || isLoading || isGenerated
      ...
      {message && (
        <div className="fixed bottom-4 right-4 p-4 bg-rose-100 text-rose-600 rounded-lg z-50 shadow-md">
          {message}
        </div>
      )}
      ...
      <div ref={outputRef} className="mt-6 w-full">
        {hook && (
          <Card className="p-8 bg-rose-50 shadow-lg rounded-2xl border border-rose-300">
            ...
            <p className="text-gray-800">
              <strong>Educational Board:</strong>{" "}
      ...
      <div className="w-full mt-8">
        <Card className="p-6 bg-white shadow-md rounded-lg border border-gray-200">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-2xl font-bold text-rose-600">History</h2>
            {history.length > 0 && (
                  ...
                  <div className="flex justify-between items-center">
                    <div className="flex-1">
                      <div className="flex items-center space-x-4">
                        <div className="flex-1">
                          <p className="font-medium text-rose-600 truncate">
                            {item.topic}
                          </p>
                    ...
                    <div className="flex space-x-2">
                      ...
                      <Button
                        ...
                        disabled={isDeleting}
                        className={`p-1 bg-rose-600 hover:bg-rose-700 text-white ${
          ...
          <Card className="bg-white rounded-lg shadow-lg max-w-2xl w-full max-h-[80vh] overflow-y-auto">
            <div className="p-6">
              ...
              <div className="space-y-2">
                <p>
                  <strong>Grade Level:</strong> {viewingHook.grade}
                </p>
                <p>
                  <strong>Subject:</strong>{" "}
                  {subjects.find((s) => s.value === viewingHook.subject)?.label}
                </p>
                <p>
                  <strong>Country:</strong>{" "}
                  {
                    countries.find((c) => c.value === viewingHook.country)
                      ?.label
                  }
                </p>
                <p>
                  <strong>Board:</strong>{" "}
                  {boards.find((b) => b.value === viewingHook.board)?.label}
                </p>
                <p>
                  <strong>Hook Type:</strong> {viewingHook.hook_type}
                </p>
                <p>
                  <strong>Learning Objective:</strong> {viewingHook.objective}
                </p>
                <p>
                  <strong>Created:</strong> {formatDate(viewingHook.created_at)}
                </p>
              ...
              <div className="mt-6 flex space-x-4">
                <Button
                  ...
                  className="flex-1"
                  onClick={() =>
                    copyHookFromHistory(viewingHook.generated_hook)
                  }
                >
